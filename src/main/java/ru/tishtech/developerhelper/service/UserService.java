...
public class UserService implements UserDetailsService {
  ...
  public List<String> getPasswordErrors(
      User user, String oldPassword, String newPassword, String confirmNewPassword) {
  ...
  public List<String> getValidationErrors(
      User user, BindingResult bindingResult, String confirmPassword) {
