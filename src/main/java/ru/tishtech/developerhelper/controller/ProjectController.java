...
public class ProjectController {
    ...
    @PostMapping(value = "/{user}/project", params = {"addVariable"})
    public String addVariable(@AuthenticationPrincipal User currentUser, @PathVariable User user,
    ...
    @PostMapping(value = "/{user}/project", params = {"removeVariable"})
    public String removeVariable(@AuthenticationPrincipal User currentUser, @PathVariable User user,
                                 @RequestParam String removeVariable, Project project, Model model) {
        if (currentUser.equals(user)) {
    ...
    public String projectSave(@AuthenticationPrincipal User currentUser, @PathVariable User user, Project project) {
        if (currentUser.equals(user)) {
    ...
    public String projectDelete(@AuthenticationPrincipal User currentUser, @PathVariable User user,
    ...
    public String projectGenerate(@AuthenticationPrincipal User currentUser, @PathVariable User user,
                                  @PathVariable Project project, HttpServletRequest request, Model model) {
        if (currentUser.equals(user)) {
    ...
    public @ResponseBody byte[] projectDownload(@AuthenticationPrincipal User currentUser, @PathVariable User user,
                                                @PathVariable Project project, @RequestParam String projectPath,
